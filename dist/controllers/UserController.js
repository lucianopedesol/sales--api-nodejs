...
class UserController {
    index(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const users = yield connection_1.default.select('id', 'name', 'email', 'active').from('users');
    ...
    show(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield connection_1.default.select('id', 'name', 'email').from('users').where({ id });
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield connection_1.default.select('password_hash', 'email').from('users').where({ id }).first();
                if (!user)
                    return response.status(400).json({
                        error: 'Invalid user'
                    });
